...
ESR1BioGrid <- read.csv("../Figure 4ABCDEFGH/esr1-biogrid/BIOGRID-GENE-108403-4.4.245.tab3.txt", sep =
                          "\t")
...
Figure5ABCDE<-ggarrange(row2,row3,nrow=2)
Figure5ABCDE
#ggsave("Figure5ABCDE.svg",FigureABCDE,units="mm",dpi=300,width=180, height=140)
