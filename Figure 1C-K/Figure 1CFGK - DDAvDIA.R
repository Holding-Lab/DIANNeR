#####
# Figure 1C, 1F, 1G, K
# Hypergeometric tests and exploratory plots for understanding relationship between N and P-value
# 23/7/2026
####
...
groups <- unique(combined_df_sig$MSacquisition)
...
BioGrid<-read.delim("../Figure 1H/BIOGRID-GENE-109165-4.4.245.DOWNLOADS/BIOGRID-GENE-109165-4.4.245.tab3.txt")
...
###Did DDA find FOXP - No. Orbitrap was run at 1 hour, for our main dataset TimsTOF ran for 1 hour and finds it.
