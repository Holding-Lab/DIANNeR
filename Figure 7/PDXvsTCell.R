...
plotPDX <- function(DEResultsPDX, 
  ...
  # --- ADD SIGNIFICANCE STARS DIRECTLY ON THE BARS ---
  long_data <- long_data %>%
  ...
  # This explicitly visualizes the model-to-model heterogeneity side-by-side.
...
# z2<-plotProteins(filtered_genes_colour, EpiComplex , "BB7_GR_IP_vs_BB3RC31_GR_IP_log2.fold.change", FALSE )
# z3<-plotProteins(filtered_genes_colour, EpiComplex , "BB3RC31_IgG_IP_vs_BB3RC31_GR_IP_log2.fold.change", FALSE )
# ggarrange(q2,z1,z2,z3, ncol = 4, nrow = 1, labels = c("A"))


#https://pmc.ncbi.nlm.nih.gov/articles/PMC7299846/
#https://pmc.ncbi.nlm.nih.gov/articles/PMC5159442/

#Clinical information 	                      PDX information
#Model 	  Type 	Pathology 	ER 	  PR 	  Her2 	ER 	PR 	  Her2 	Passage Lung Mets
#BB3RC29 	MBC 	NA 	        Pos 	Neg 	Neg 	Neg 	Neg 	Neg 	P9
#BB3RC31 	MBC 	IDC 	      Pos 	Pos 	Neg 	Pos 	Pos 	Neg 	P8 	    Yes -

#https://link.springer.com/article/10.1007/s10549-011-1815-5#SecESM1
#                         Age T(mm)   p/N   ER  PR  HER2  Grade Chemo   Hormonal Therapy  Trastuzumab Radiation Outcome
#HBCx-34  EBC   IDC	      37  14	    0/3	  30	10	0	    3	    FEC–P	  Goserelin	         No	        No	      NED(42 m)
#(EBC = early, MBC=met, NED=no evidence of disease)
