...
p1<-EnhancedVolcano(DEResultsReorder,
                ...
                title = NULL,
                subtitle = NULL,
                caption = "Normal Breast Epithelium (left) vs Normal CD4+T Cells (right)",
                drawConnectors = TRUE,
                widthConnectors = 0.4,
                boxedLabels = TRUE,
                pointSize = 1.0,
...
p2<-EnhancedVolcano(DEResultsReorder,
                ...
                title = NULL,
                subtitle = NULL,
                caption = "Normal Urothelium (left) vs Normal CD4+T Cells (right)",
                drawConnectors = TRUE,
                widthConnectors = 0.4,
                boxedLabels = TRUE,
                pointSize = 1.0,
...
p5<-EnhancedVolcano(DEResultsFOX_BRAFreorder,
                    ...
                    title = NULL,
                    subtitle = NULL,
                    caption = "Jurkat Cells (left) vs Normal CD4+T Cells (right)",
                    drawConnectors = TRUE,
                    widthConnectors = 0.4,
                    boxedLabels = TRUE,
                    pointSize = 1.0,
...
row1<-ggarrange(p1,p3,p4,ncol=3)
row2<-ggarrange(p2,p4,ncol=3)
